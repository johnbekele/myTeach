...
3. `generate_exercise` - Create follow-up exercise if needed

If they passed: Celebrate success and move to next challenge
If they failed: Provide encouragement and specific guidance"""
